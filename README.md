<table align=center>
  <td width=350>
   <div id="header" align="center">
    ...
    <p>:woman_student: Привет, меня зовут Лейла и я в поиске работы фронтенд разработчика/верстальщика.<p> 
    <table>
        <tr>
          <td width=200>
            <p>👨‍💻 Выпускница Яндекс.Практикума по специальности "Веб-разработчик"<p>
          </td>
          <td width=100>
            <div align=center>
